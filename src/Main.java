public class Main {
    public static void main(String[] args) {
        ...
        SubTask sub1 = new SubTask("Забронировать зал", "Позвонить в ресторан", TaskStatus.NEW, epic1.id);
        SubTask sub2 = new SubTask("Найти фотографа", "Позвонить Сергею", TaskStatus.NEW, epic1.id);
        manager.addSubtask(sub1);
        manager.addSubtask(sub2);

        Epic epic2 = new Epic("Покупка квартиры", "Все шаги до сделки");
        manager.addEpic(epic2);
        SubTask sub3 = new SubTask("Ипотека", "Подать заявку", TaskStatus.NEW, epic2.id);
        ...
        sub1.status = TaskStatus.DONE;
        sub2.status = TaskStatus.IN_PROGRESS;
